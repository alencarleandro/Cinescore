...
async function carregarFavoritos() {
  ...
  if (localStorage.getItem("emailUsuario") != null) {
    ...
    const responseTitulosMaisCurtidos = await fetch(`${API_BASE_URL}/api/feedback/titulosMaisCurtidos`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json'
      }
  ...
  const responsePorcentagem = await fetch(`${API_BASE_URL}/api/feedback/indicadorPorcentagemPositiva`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json'
    }
